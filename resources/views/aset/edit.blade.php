...
<div class="card card-primary card-outline form-edit-aset">
            ...
            {{-- JENIS --}}
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="klasifikasi_barang_id"
                                class="form-control">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="ruangan_id"
                            ...
                            <option value="{{ $r->id }}"
                                {{ old('ruangan_id',$aset->ruangan_id) == $r->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select name="kondisi"
                            ...
                            <option value="rusak_ringan"
                                {{ old('kondisi',$aset->kondisi)=='rusak_ringan'?'selected':'' }}>
                                Rusak Ringan
                            </option>


                            <option value="rusak_berat"
                                {{ old('kondisi',$aset->kondisi)=='rusak_berat'?'selected':'' }}>
                                Rusak Berat
                            </option>


                            <option value="hilang"
                                {{ old('kondisi',$aset->kondisi)=='hilang'?'selected':'' }}>
                                Hilang
                            </option>
