...
@php
    ...
    $formattedTanggal = $kir->tanggal ? \Carbon\Carbon::parse($kir->tanggal)->format('d/m/Y') : '-';
    $tanggalTtdVal = $kir->tanggal ? \Carbon\Carbon::parse($kir->tanggal)->format('Y-m-d') : date('Y-m-d');
@endphp
    ...
    <div class="card-header d-flex align-items-center flex-wrap">
        <div class="mr-auto">
            <h3 class="card-title mb-0">
                ...
                KIR #{{ $i + 1 }}
                &nbsp;—&nbsp;
                <strong>{{ $formattedTanggal }}</strong>
        ...
        <div class="d-flex align-items-center flex-wrap" style="gap:4px">
            ...
            @if($siapCetak)
                ...
                <form method="POST" action="{{ route('laporan.cetak-kir.pdf', $kir->id) }}" class="kir-aksi-form">
                    @csrf
                    <input type="hidden" name="periode" value="{{ $kir->keterangan ?? ($kir->tanggal ? \Carbon\Carbon::parse($kir->tanggal)->locale('id')->translatedFormat('F Y') : date('F Y')) }}">
                    ...
                    <input type="hidden" name="tanggal_ttd" value="{{ $tanggalTtdVal }}">
